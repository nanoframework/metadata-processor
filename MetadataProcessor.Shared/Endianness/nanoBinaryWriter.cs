...
namespace nanoFramework.Tools.MetadataProcessor
{
    ...
    {
        /// <summary>
        /// Specialized big endian version of <see cref="nanoBinaryWriter"/> class.
        /// </summary>
        private sealed class BigEndianBinaryWriter : nanoBinaryWriter
        {
            ...
            /// <summary>
            /// Creates new instance of <see cref="nanoBinaryWriter.BigEndianBinaryWriter"/> object.
            /// </summary>
        ...
        /// <summary>
        /// Specialized little endian version of <see cref="nanoBinaryWriter"/> class.
        /// </summary>
        private sealed class LittleEndianBinaryWriter : nanoBinaryWriter
        {
            /// <summary>
            /// Creates new instance of <see cref="nanoBinaryWriter.LittleEndianBinaryWriter"/> object.
            /// </summary>
            /// <param name="baseWriter">Base binary writer for operating on stream.</param>
        ...
        /// <summary>
        /// Creates new instance of <see cref="nanoBinaryWriter"/> object.
        /// </summary>
        /// <param name="baseWriter">Base binary writer for operating on stream.</param>
        ...
        /// <summary>
        /// Factory mathod for creating little endian version of <see cref="nanoBinaryWriter"/> class.
        /// </summary>
        /// <param name="baseWriter">Base binary writer for operating on stream.</param>
        /// <returns>
        /// Instance of <see cref="nanoBinaryWriter"/> which writes bytes in little endian.
        /// </returns>
        ...
        /// <summary>
        /// Factory mathod for creating big endian version of <see cref="nanoBinaryWriter"/> class.
        /// </summary>
        /// <param name="baseWriter">Base binary writer for operating on stream.</param>
        /// <returns>
        /// Instance of <see cref="nanoBinaryWriter"/> which writes bytes in big endian.
        /// </returns>
        ...
        /// <summary>
        /// Creates new instance of <see cref="nanoBinaryWriter"/> object with same endiannes
        ...
        /// <returns>New instance of <see cref="nanoBinaryWriter"/> object with same endiannes.</returns>
