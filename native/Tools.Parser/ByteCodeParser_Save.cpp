...
HRESULT MetaData::ByteCode::GenerateOldIL(std::vector<BYTE> &code)
{
    ...
    for (i = 0; i < len; i++)
    {
        ...
        if (ref.m_ol->m_flags & CLR_RT_OpcodeLookup::ATTRIB_HAS_TOKEN)
        {
            ...
            switch (ref.m_ol->m_opParam)
            {
                case CLR_OpcodeParam_Field:
                    NANOCLR_CHECK_HRESULT(CLR_CompressFieldToken(tk));
                    NANOCLR_WRITE_UNALIGNED_UINT16(ip, (CLR_UINT16)tk);
                    break;
                case CLR_OpcodeParam_Method:
                    NANOCLR_CHECK_HRESULT(CLR_CompressMethodToken(tk));
                    NANOCLR_WRITE_UNALIGNED_UINT16(ip, (CLR_UINT16)tk);
                    break;
                case CLR_OpcodeParam_String:
                    NANOCLR_CHECK_HRESULT(CLR_CompressStringToken(tk));
                    NANOCLR_WRITE_UNALIGNED_UINT16(ip, (CLR_UINT16)tk);
                    break;
                case CLR_OpcodeParam_Type:
                    NANOCLR_CHECK_HRESULT(CLR_CompressTypeToken(tk));
                    NANOCLR_WRITE_UNALIGNED_UINT16(ip, (CLR_UINT16)tk);
                    break;
                default:
        ...
        else
        {
            ...
            switch (ref.m_ol->m_opParam)
            {
                /*#define InlineField         4, 2, */ case CLR_OpcodeParam_Field:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineMethod        4, 2, */ case CLR_OpcodeParam_Method:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineType          4, 2, */ case CLR_OpcodeParam_Type:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineString        4, 2, */ case CLR_OpcodeParam_String:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineTok           4, 4, */ case CLR_OpcodeParam_Tok:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineSig           4, 4, */ case CLR_OpcodeParam_Sig:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineBrTarget      4, 2, */ case CLR_OpcodeParam_BrTarget:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define ShortInlineBrTarget 1, 1, */ case CLR_OpcodeParam_ShortBrTarget:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineI             4, 4, */ case CLR_OpcodeParam_I:
                    NANOCLR_WRITE_UNALIGNED_INT32(ip, ref.m_arg_I4);
                    break;
                /*#define InlineI8            8, 8, */ case CLR_OpcodeParam_I8:
                    NANOCLR_WRITE_UNALIGNED_INT64(ip, ref.m_arg_I8);
                    break;
                /*#define InlineNone          0, 0, */ case CLR_OpcodeParam_None:
                    break;
                /*#define InlineR             8, 8, */ case CLR_OpcodeParam_R:
                    NANOCLR_WRITE_UNALIGNED_INT64(ip, ref.m_arg_R8);
                    break;
                /*#define InlineSwitch        4, 1, */ case CLR_OpcodeParam_Switch:
                    NANOCLR_SET_AND_LEAVE(CLR_E_FAIL);
                /*#define InlineVar           2, 2, */ case CLR_OpcodeParam_Var:
                    NANOCLR_WRITE_UNALIGNED_UINT16(ip, (CLR_UINT16)ref.m_index);
                    break;
                /*#define ShortInlineI        1, 1, */ case CLR_OpcodeParam_ShortI:
                    NANOCLR_WRITE_UNALIGNED_INT8(ip, (CLR_INT8)ref.m_arg_I4);
                    break;
                /*#define ShortInlineR        4, 4, */ case CLR_OpcodeParam_ShortR:
                    NANOCLR_WRITE_UNALIGNED_INT32(ip, ref.m_arg_R4);
                    break;
                /*#define ShortInlineVar      1, 1, */ case CLR_OpcodeParam_ShortVar:
                    NANOCLR_WRITE_UNALIGNED_UINT8(ip, (CLR_UINT8)ref.m_index);
                    break;
            }
        }
    ...
    for (i = 0; i < m_exceptions.size(); i++)
    {
        ...
        leb.m_TryLength =
            m_opcodes[leb.m_TryIndexEnd].m_ipOffset + m_opcodes[leb.m_TryIndexEnd].m_ipLength - leb.m_TryOffset;
        leb.m_HandlerOffset = m_opcodes[leb.m_HandlerIndex].m_ipOffset;
        leb.m_HandlerLength = m_opcodes[leb.m_HandlerIndexEnd].m_ipOffset +
                              m_opcodes[leb.m_HandlerIndexEnd].m_ipLength - leb.m_HandlerOffset;
