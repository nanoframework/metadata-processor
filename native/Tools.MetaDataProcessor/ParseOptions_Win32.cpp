...
CLR_RT_ParseOptions::Parameter_Generic::Parameter_Generic(LPCWSTR szName, LPCWSTR szDescription)
...
CLR_RT_ParseOptions::Parameter_String::Parameter_String(std::wstring *data, LPCWSTR szName, LPCWSTR szDescription)
    : CLR_RT_ParseOptions::Parameter(szName, szDescription)
{
...
CLR_RT_ParseOptions::Parameter_Boolean::Parameter_Boolean(bool *data, LPCWSTR szName, LPCWSTR szDescription)
    : CLR_RT_ParseOptions::Parameter(szName, szDescription)
{
    m_dataPtr = data ? data : &m_dataParsed;
}
...
bool CLR_RT_ParseOptions::Parameter_Boolean::Parse(LPCWSTR arg)
{
    ...
    if (!_wcsicmp(arg, L"true") || !_wcsicmp(arg, L"on"))
    {
        *m_dataPtr = true;
        return true;
    }

    if (!_wcsicmp(arg, L"false") || !_wcsicmp(arg, L"off"))
    {
        *m_dataPtr = false;
        return true;
    }
...
CLR_RT_ParseOptions::Parameter_Integer::Parameter_Integer(int *data, LPCWSTR szName, LPCWSTR szDescription)
    : CLR_RT_ParseOptions::Parameter(szName, szDescription)
{
    m_dataPtr = data ? data : &m_dataParsed;
}
...
CLR_RT_ParseOptions::Parameter_Float::Parameter_Float(float *data, LPCWSTR szName, LPCWSTR szDescription)
    : CLR_RT_ParseOptions::Parameter(szName, szDescription)
{
    m_dataPtr = data ? data : &m_dataParsed;
}
...
CLR_RT_ParseOptions::Command_SetFlag::Command_SetFlag(bool *data, LPCWSTR szName, LPCWSTR szDescription)
...
HRESULT CLR_RT_ParseOptions::ExtractOptionsFromFile(LPCWSTR szFileName)
{
    ...
    // TODO NANOCLR_CHECK_HRESULT(CLR_RT_FileStore::ExtractTokensFromFile(szFileName, vec));
