...
HRESULT CLR_XmlUtil::CreateParser()
{
    ...
    NANOCLR_CHECK_HRESULT(
        ::CoCreateInstance(CLSID_DOMDocument, NULL, CLSCTX_INPROC_SERVER, IID_IXMLDOMDocument, (void **)&m_xddDoc));
    ...
    /*[in]*/ bool fDeep)
{
    ...
    NANOCLR_CHECK_HRESULT(xdnNode->get_childNodes(&xdnlList));
    xdnNode = NULL;
...
HRESULT CLR_XmlUtil::LoadAsStream(
    /*[in ]*/ IUnknown *pStream,
    /*[in ]*/ LPCWSTR szRootTag,
    /*[out]*/ bool &fLoaded,
    /*[out]*/ bool *fFound)
...
HRESULT CLR_XmlUtil::LoadAsString(
    /*[in ]*/ BSTR bstrData,
    /*[in ]*/ LPCWSTR szRootTag,
    /*[out]*/ bool &fLoaded,
    /*[out]*/ bool *fFound)
...
HRESULT CLR_XmlUtil::SetVersionAndEncoding(
...
HRESULT CLR_XmlUtil::CreateNode(
    /*[in ]*/ LPCWSTR szTag,
    ...
    /*[in ]*/ IXMLDOMNode *pxdnNode)
{
    ...
    if (m_xdnRoot)
    {
        ...
        {
            pxdnNode = m_xdnRoot;
        } // Use root as base of search, if no base node is supplied.
...
HRESULT CLR_XmlUtil::GetAttribute(
    /*[in ]*/ LPCWSTR szTag,
    /*[in ]*/ LPCWSTR szAttr,
...
HRESULT CLR_XmlUtil::ModifyAttribute(
    /*[in ]*/ LPCWSTR szTag,
    /*[in ]*/ LPCWSTR szAttr,
...
HRESULT CLR_XmlUtil::ModifyValue(
    /*[in ]*/ LPCWSTR szTag,
...
HRESULT CLR_XmlUtil::PutAttribute(
    /*[in ]*/ LPCWSTR szTag,
    /*[in ]*/ LPCWSTR szAttr,
    /*[out]*/ IXMLDOMAttribute **pVal,
    /*[out]*/ bool &fFound,
...
HRESULT CLR_XmlUtil::RemoveAttribute(
    /*[in]*/ LPCWSTR szTag,
    /*[in]*/ LPCWSTR szAttr,
    /*[in]*/ IXMLDOMNode *pxdnNode)
{
...
HRESULT CLR_XmlUtil::RemoveValue(
    /*[in]*/ LPCWSTR szTag,
    /*[in]*/ IXMLDOMNode *pxdnNode)
{
    NANOCLR_HEADER();
...
HRESULT CLR_XmlUtil::RemoveNode(
    /*[in]*/ LPCWSTR szTag,
    /*[in]*/ IXMLDOMNode *pxdnNode)
{
    NANOCLR_HEADER();
