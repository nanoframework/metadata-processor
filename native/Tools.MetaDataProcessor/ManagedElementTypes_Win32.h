...

{
  public:
    ...
    virtual string GetVariableDecl()
    {
        return CLR_RT_ManagedElementType::GetVariableDecl() + " *";
    }
...
class CLR_RT_ManagedElementTypeArray : public CLR_RT_ManagedElementType
{
  public:
    ...
    virtual string GetVariableDecl()
    {
        return "CLR_RT_TypedArray_" + CLR_RT_ManagedElementType::GetVariableDeclForTypedArray();
    }
