...
//            TestSingleAssembly(name, "le", loadHints, nanoBinaryWriter.CreateLittleEndianBinaryWriter);
//            TestSingleAssembly(name, "be", loadHints, nanoBinaryWriter.CreateBigEndianBinaryWriter);
//        }

//        private static void TestSingleAssembly(
//            String name, String endianness, IDictionary<String, String> loadHints,
//            Func<BinaryWriter, nanoBinaryWriter> getBinaryWriter)
//        {
